...
namespace OBF.Modules
{
    ...
    {
        public static void CheckIsAttached(AssemblyDefinition assembly)
        {
        ...
        public static void CheckEnvironment(AssemblyDefinition assembly)
        {
            foreach (var module in assembly.Modules)            
                foreach (var type in module.Types)                
                    foreach (var method in type.Methods)                    
        ...
        public static void CheckTiming(AssemblyDefinition assembly)
        {
            foreach (var module in assembly.Modules)            
                foreach (var type in module.Types)                
                    foreach (var method in type.Methods)                    
        ...
        public static void CheckDebuggerAPI(AssemblyDefinition assembly)
        {
            foreach (var module in assembly.Modules)            
                foreach (var type in module.Types)                
                    foreach (var method in type.Methods)                    
